...
img_search_path = "/home/sean/Documents/courses/google_python_automation/course 6"
resize_to = (600,400)
...
def modify_image(img, img_dimensions):
    im = Image.open(img)
    print("Saving file: {}, at {}.jpeg".format(img, img))
    file_name = os.path.basename(img)
    im.resize(img_dimensions).convert("RGB").save("{}/{}.jpeg".format(save_files_loc,file_name))
